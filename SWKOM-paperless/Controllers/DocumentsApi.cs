...
namespace Org.OpenAPITools.Controllers
{
    ...
    public class DocumentsApiController : ControllerBase
    {
        ...
        public virtual async Task<ListResponse<SWKOM_paperless.BusinessLogic.Entities.Document>> GetDocuments(
            [FromQuery(Name = "Page")] int? page, [FromQuery(Name = "page_size")] int? pageSize,
            [FromQuery(Name = "query")] string query, [FromQuery(Name = "ordering")] string ordering,
        ...
        {
            var documents = await documentsService.GetDocuments();

            return new ListResponse<SWKOM_paperless.BusinessLogic.Entities.Document>()
            {
